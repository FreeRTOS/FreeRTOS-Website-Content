...
而互斥锁是实现简单互斥的更好选择。description[](/Documentation/02-Kernel/02-Kernel-features/02-Queues-mutexes-and-semaphores/04-Mutexes/)
...
始终“提供”信号量（将写入队列使其为满），但从不获取信号量。源代码
...
。在 FreeRTOS/Demo/Common/Minimal 目录下搜索文件，您将会看到多个用法
示例。请注意，中断只能使用以 "FromISR" 结尾的 API 函数。
